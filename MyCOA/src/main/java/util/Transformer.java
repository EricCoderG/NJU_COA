...
public class Transformer {
     ...
     * @return result
     */
    public static int valueOf(String num, int radix) {
        int ans = 0;
...
//        if (val == 0) return "1100 0000";
     ...
     */
    public static String getBCDString_4(int val) {
        String result = "";
     ...
     * @return result
     */
    public static float maxValue(int length) {
        //不能使用移位操作
     ...
     * @return result
     */
    public static boolean isFinite(float d, int eLength, int sLength) {
        int bias = (int) ((maxValue(eLength) + 1) / 2 - 1);  //bias
...
//		return result;  //用于测试最大值
     ...
     * @return result
     */
    public static float minNormal(int eLength, int sLength) {
        int bias = (int) ((maxValue(eLength) + 1) / 2 - 1);  //bias
     ...
     */
    public static String fixPoint(float d, int sLength) {
     ...
     * @return exponent
     */
    public static float getExponent(float d) {
